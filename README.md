...
| `src/assignement3/CodeMotion.cpp`  | `code-motion`      | `./lib/libCodeMotion.so`  | `../test/test_CodeMotion.ll`  | `opt -S -load-pass-plugin ./lib/libCodeMotion.so -p "loop-simplify,code-motion" ../test/test_CodeMotion.ll` |
